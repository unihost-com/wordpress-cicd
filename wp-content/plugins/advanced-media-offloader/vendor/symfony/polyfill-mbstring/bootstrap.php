...
if (!\function_exists('WPFitter\\mb_str_pad')) {
    /** @internal */
...
if (!\function_exists('WPFitter\\mb_ucfirst')) {
    /** @internal */
...
if (!\function_exists('WPFitter\\mb_lcfirst')) {
    /** @internal */
...
if (!\function_exists('WPFitter\\mb_trim')) {
    /** @internal */
...
if (!\function_exists('WPFitter\\mb_ltrim')) {
    /** @internal */
...
if (!\function_exists('WPFitter\\mb_rtrim')) {
    /** @internal */
